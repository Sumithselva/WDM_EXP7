...
def hits_algorithm(adjacency_matrix, max_iterations=2, tol=1.0e-6):
...
### Output:
<img width="803" height="909" alt="image" src="https://github.com/user-attachments/assets/8a6a9401-be8c-4698-a5ae-6b8a21aa01dd" />


### Result:
 The implementation Link Analysis using HITS Algorithm in Python is successfully executed.
